...
**Files:**
- Create: `src/AzureServiceBusEmulator.Core/Broker/SessionManager.cs`
...
```csharp
// src/AzureServiceBusEmulator.Core/Broker/SessionManager.cs
...
Run: `dotnet test AzureServiceBusEmulator.sln --filter "FullyQualifiedName!~RealAsbConformanceTests" --verbosity quiet`
...
**Files:**
- Create: `src/AzureServiceBusEmulator.Core/Amqp/SessionReceiverLinkEndpoint.cs`
...
```csharp
// src/AzureServiceBusEmulator.Core/Amqp/SessionReceiverLinkEndpoint.cs
using global::Amqp;
...
**Files:**
- Modify: `src/AzureServiceBusEmulator.Core/Amqp/ServiceBusLinkProcessor.cs`
...
**Files:**
- Modify: `src/AzureServiceBusEmulator.Core/Amqp/ManagementLinkEndpoint.cs`
...
**Files:**
- Modify: `tests/AzureServiceBusEmulator.Conformance.Tests/ConformanceTestBase.cs`
...
Run: `dotnet test tests/AzureServiceBusEmulator.Conformance.Tests --filter "FullyQualifiedName~EmulatorConformanceTests.Session" --verbosity normal`
