...
public static class ManagementApiEndpoints
{
    ...
    private static NamespaceContext ResolveNamespace(HttpRequest request, NamespaceRegistry registry)
    {
        ...
        // Fallback: hostname-based resolution. Some container/service names (e.g.
        // "servicebus-emulator") are operational aliases for the default namespace, not
        // distinct namespaces; treat them as the default namespace to keep the host name
        // from causing a namespace split across container networking.
