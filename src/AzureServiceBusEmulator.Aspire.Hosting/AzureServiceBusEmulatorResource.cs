...
/// </summary>
public class AzureServiceBusEmulatorResource : ExecutableResource, IResourceWithConnectionString
{
    ...
    /// <summary>
    /// Initialises a new <see cref="AzureServiceBusEmulatorResource"/>.
    /// </summary>
    ...
    public AzureServiceBusEmulatorResource(string name, string workingDirectory, int dashboardPort)
